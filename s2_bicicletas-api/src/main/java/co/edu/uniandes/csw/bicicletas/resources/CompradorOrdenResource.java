...
public class CompradorOrdenResource {
     ...
     * @return JSONArray {@link OrdenDTO} - Las ordenes asociadas.
     ...
     *
     * @param compradorId Identificador del comprador asociado.Este
     ...
     * Error de lógica que se genera cuando no se encuentra la orden en
     * el comprador.
     */
    @GET
    @Path("{ordenId: \\d+}")
