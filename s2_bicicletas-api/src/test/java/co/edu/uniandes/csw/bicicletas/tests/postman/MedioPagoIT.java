...
import co.edu.uniandes.csw.bicicletas.resources.MedioPagoResource;
...
public class MedioPagoIT {
    private static final String COLLECTION = "MedioPagoResourceTest.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s2_bicicletas-api.war")//War del modulo api
                ...
                .addPackage(MedioPagoResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(MedioPagoDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
